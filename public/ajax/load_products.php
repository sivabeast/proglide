...
/* ===============================
   LOOP THROUGH PRODUCTS - FIXED BUTTONS
================================ */
while ($p = $result->fetch_assoc()) {
    ...
    // Check if in cart - FIXED: Added span for text
    $in_cart = '';
    ...
    // Build HTML - FIXED: Proper button structure with spans
    $html .= '
    ...
    if ($p['is_popular']) {
        $html .= '<span class="popular-badge"><i class="fas fa-crown"></i> Popular</span>';
    }
    ...
    // FIXED: Button based on category with proper spans
