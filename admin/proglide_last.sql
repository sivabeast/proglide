...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2026 at 02:15 PM
...
(1, 'admin', 'admin@protectors.com', '$2y$10$gww9rk/FnF5pfiIuOQD2suxWOYFrKeZ7siflJZHD0/leqbYbOUw/i', '2026-01-16 14:12:42');
...
CREATE TABLE `categories` (
  ...
  `status` tinyint(4) DEFAULT 1,
  `show_on_home` tinyint(4) DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `material_types`
  ADD CONSTRAINT `material_types_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `phone_models`
  ADD CONSTRAINT `phone_models_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`material_type_id`) REFERENCES `material_types` (`id`),
  ADD CONSTRAINT `products_ibfk_3` FOREIGN KEY (`variant_type_id`) REFERENCES `variant_types` (`id`);

--
-- Constraints for table `variant_types`
--
ALTER TABLE `variant_types`
  ADD CONSTRAINT `variant_types_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE;
